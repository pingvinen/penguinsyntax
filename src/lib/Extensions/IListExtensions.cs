...
namespace PenguinSyntax.Extensions
{
	...
	public static class IListExtensions
	{
		...
		/// </typeparam>
		public static bool IsPatternPresent<T>(this IList<T> list, int startIndex, Func<T, T, bool> tester, IList<T> pattern)
		{
			int listIndex;
		...
		{
			return list.IsPatternPresent(startIndex, tester, new List<T>(pattern));
		}
